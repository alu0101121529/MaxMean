 ...
 * @brief Fichero que contiene la clase MultiStart que tiene los métodos necesarios para resolver
 *        el algoritmo Max Mean usando Multi Arranque
 * @version 1.0
 * @date 2020-04-27
 * 
 ...
 * @class MultiStart
 * 
 * @brief MultiStart implementation to solve Max Mean
 * 
 */
...
public:
  /**
   * @brief Construct a new Multi Start object
   * 
   * @param filename 
   * @param iter 
   * @param noimprov 
   * @param anx 
   */
  MultiStart(std::string filename, int iter, int noimprov, bool anx) : Algorithm(filename), Iterations(iter), NoImprov(noimprov), anxious(anx) {}
  /**
